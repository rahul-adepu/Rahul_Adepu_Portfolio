...
import resume from "../files/Rahul_Adepu_Resume.pdf";
      ...
      <nav className={styles.nav}>
        ...
        <div>
          <ul id={styles.nav_links}>
            ...
            <li>
              <a href="#techstacks" onClick={scrollToSection("techstacks")}>
                Skills
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#statistics" onClick={scrollToSection("statistics")}>
                Statistics
              </a>
            </li>
            <li>
