...
const Projects = () => {
  const dunzolink = () => {
    window.open("https://dunzo-delta.vercel.app/");
  };
  ...
  const noteslink = () => {
    window.open("https://notes-app-sandy-tau.vercel.app/");
  };
      ...
      <div className="Projectcards-div">
        ...
        <div className="card project-card">
          ...
          <div className="content">
            ...
            <p className="para project-description">
              The Dunzo Clone is a web application built using the MERN stack,
              focusing primarily on an intuitive and visually appealing UI. It
              features store-wise product listings with an add-to-cart
              functionality, ensuring a seamless browsing experience. The design
              emphasizes smooth navigation and responsiveness across all
              devices. The frontend is developed using React.js and Tailwind
              CSS, while Node.js, Express.js, and MongoDB handle the backend.
            </p>
        ...
        <div className="card project-card">
          ...
          <div className="content">
            ...
            <p className="para project-description">
              The Notes App is a responsive web application built using the MERN
              stack, allowing users to create, edit, and delete notes
              effortlessly. The UI is designed to be clean and user-friendly,
              ensuring a smooth experience across all devices. With a focus on
              simplicity and efficiency, users can manage their notes
              seamlessly. The frontend is built using React.js and Tailwind CSS,
              while Node.js, Express.js, and MongoDB handle the backend. This
              project highlights my skills in building intuitive and responsive
              interfaces.
            </p>
            <div className="project-tech-stack techstacks">
              <Tooltip
